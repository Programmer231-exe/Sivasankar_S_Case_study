...
<div class = "container">
    <h4>Login Page</h4>
    <div ><img src = "https://image.shutterstock.com/image-vector/user-icon-600w-523867123.jpg" alt = "icon" width="200px" height="200px"/></div>
<form id = "loginform" action = "${pageContext.request.contextPath}/patient/validate" method = "post" onsubmit = "return check()">
...
<footer>
    ...
    <div id = "note"><p>To create an Account . Reach the nearby hospital</p></div>
</footer>
<script type = "text/javascript" src = "${pageContext.request.contextPath}/static/js/login.js" defer >
